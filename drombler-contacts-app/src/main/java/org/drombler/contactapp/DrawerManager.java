...
import static org.drombler.contactapp.ContactsApp.PRIMARY_VIEW;
import static org.drombler.contactapp.ContactsApp.SECONDARY_VIEW;
...
public class DrawerManager {
    ...
    public static void buildDrawer(MobileApplication app) {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("Drombler Contacts App",
                "",
